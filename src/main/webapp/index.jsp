...
<div class="row">
    ...
    <p>Use this base URL :</p><input id="byZip" value="http://18.221.180.234:8080/waterfallRest/waterfalls/zipcode/53705" /><button onclick="copyToClipByZip()">Copy</button>
</div>
</div>
</div>
<div class="container-fluid col-md-8 col-md-offset-2">
...
<div class="row">
    <div class="well" id="userWell">
    <p>Use this base URL :</p><input id="byName" value="http://18.221.180.234:8080/waterfallRest/waterfalls/name/Little%20River%20Falls" /><button onclick="copyToClipByName()">Copy</button>
</div>
</div>
</div>
<div class="container-fluid col-md-8 col-md-offset-2">
...
<div class="row">
    <div class="well" id="userWell">
    <p>Use this base URL :</p><input id="byLatLng" value="http://18.221.180.234:8080/waterfallRest/waterfalls/latitude/-40.0/longitude/100.00011" /><button onclick="copyToClipByLatLng()">Copy</button>
</div>
</div>
</div>
<div class="container-fluid col-md-8 col-md-offset-2">
...
<div class="row">
    <div class="well" id="userWell">
    <p>Use this base URL :</p><input id="all" value="http://18.221.180.234:8080/waterfallRest/waterfalls/all" /><button onclick="copyToClipAll()">Copy</button>
</div>
</div>
</div>
</body>
